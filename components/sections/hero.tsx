            ...
            <div className="max-w-4xl w-full flex flex-col-reverse md:flex-row items-center md:items-start justify-between gap-8 md:gap-10">
                <div className="flex flex-col items-center md:items-start text-center md:text-left gap-5 md:gap-6 flex-1 mt-2 md:mt-0">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-md leading-relaxed">
                         Memiliki pengalaman di bidang <strong className="text-foreground font-semibold">data analytics</strong> dan <strong className="text-foreground font-semibold">system development</strong> dalam membangun solusi digital <em className="italic">berbasis data</em>  yang efisien dan terintegrasi, serta didukung pengalaman dalam <strong className="text-foreground font-semibold">full stack web development.</strong>
                    </p>
                </div>
